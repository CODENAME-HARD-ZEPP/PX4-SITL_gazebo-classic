...
static const std::string topic_name_wind_speed = "wind_speed";
static const std::string topic_name_external_force = "external_force";
 ...
 public:
  GazeboWindPlugin()
      ...
      //   wind_force_pub_topic_(mav_msgs::default_topics::EXTERNAL_FORCE),
        wind_force_pub_topic_(topic_name_external_force),
      //   wind_speed_pub_topic_(mav_msgs::default_topics::WIND_SPEED),
        wind_speed_pub_topic_(topic_name_wind_speed),
